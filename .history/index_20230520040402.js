...
// Xử lý sự kiện khi customerId thay đổi
customerIdInput.addEventListener('input', function() {
  var customerId = this.value;

  // Gửi yêu cầu AJAX đến server để lấy customerName
  axios.post('/chungtu/hoadonGTGT', { customerId: customerId })
    .then(function(response) {
      var customerName = response.data.customerName;

      // Hiển thị customerName tương ứng
