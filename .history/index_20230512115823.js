...
app.post('/danhmuc/khachhang', function(req, res)  {
    ...
    con.connect(function(err){
        if(err) {
            ...
            var sql = "INSERT INTO khachhang(MaKH, TenKH, MaSoThue, HinhThuc, Email, SDT, DiaChi) VALUES ?";

            var values =[
                [dbo.AUTO_IDKH(), TenKH, MaSoThue, HinhThuc, Email, SDT , DiaChi]
            ];
...
app.post('/danhmuc/dichvu-update', function(req, res){
    ...
    con.connect(function(err){
        ...
        var sql = "UPDATE dichvu SET TenDV=?, PhanLoai=?, DonGia=?, MoTa=? WHERE MaKH=?";
...
// -------------- 2.1. Hóa đơn GTGT ----------------
app.get('/chungtu/hoadonGTGT-preview',function(req, res, result){
...
app.post('/chungtu/hoadonGTGT', function(req, res)  {
    ...
    con.connect(function(err){
        if(err) {
            ...
            var sql = "INSERT INTO hddv (SoCT, NgayCT, MaKH, TenKH, MaSoThue, TKNoTT, TKCoDT, TKCoThue, ThueSuat, HTTT, STK, NganHang, TKChietKhau, TyLeCK) VALUES ?";

            var values =[
                [SoCT, NgayCT, MaKH, TenKH, MaSoThue, TKNoTT, TKCoDT, TKCoThue, ThueSuat, HTTT, STK, NganHang, TKChietKhau, TyLeCK]
            ];
