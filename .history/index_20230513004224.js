...
app.post('/chungtu/hoadonGTGT', function(req, res)  {
    ...
    con.connect(function(err){
        if(err) {
            ...
            var sql = "INSERT INTO hddv (SoCT, NgayCT, MaKH, MaSoThue, TKNoTT, TKCoDT, TKCoThue, ThueSuat, HTTT, STK, NganHang, TKChietKhau, TyLeCK) VALUES ?";

            var values =[
                [SoCT, NgayCT, MaKH, MaSoThue, TKNoTT, TKCoDT, TKCoThue, ThueSuat, HTTT, STK, NganHang, TKChietKhau, TyLeCK]
            ];
