...
function calc(){
  ...
  if (isNaN(SoLuong) || isNaN(DonGia)){
    ...
    var resTT = parseInt(DonGia) * parseInt(SoLuong);
    document.getElementById('TienDV').value = resTT;
  }

  // 
  var resTienDoanhThu =  resTT;
  // document.getElementById('TienDT').value = resTienDoanhThu;

  var Thue = document.getElementById('tax').value;
  document.getElementById('tax').value = Thue;

  var TienThue =  parseInt(Thue) * parseInt(resTienDoanhThu);
  document.getElementById('TienThue').value = TienThue;

  var TienTT = parseInt(resTienDoanhThu) - parseInt(TienThue);
  document.getElementById('TienTT').value = TienTT;
