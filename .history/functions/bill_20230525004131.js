...
function getCustomerInfo() {
  ...
  // Gửi yêu cầu AJAX đến đường dẫn /chungtu/hoadonGTGT
  var xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() {
    if (this.readyState === 4 && this.status === 200) {
      var billData = JSON.parse(this.responseText);

      // Gán giá trị từ dữ liệu hóa đơn vào các trường thông tin trên form
      document.getElementById("customerName").value = billData.TenKH;
      document.getElementById("taxId").value = billData.MaSoThue;
    }
  };
