...
function calc(){
  ...
  if (isNaN(SoLuong) || isNaN(DonGia)){
    ...
    var result = parseInt(DonGia) * parseInt(SoLuong);
    document.getElementById('TienDV').value = result;
  }

  // 
  var TienDoanhThu =  document.getElementById('TienDV').value;
  document.getElementById('TienDT').value = TienDoanhThu;

  var Thue = document.getElementById('tax').value;
  var TienThue =  (parseInt(Thue)/100) * parseInt(TienDoanhThu);
  document.getElementById('TienThue').value = TienThue;

  document.getElementById('TienTT').value = parseInt(TienDoanhThu)-parseInt(TienThue);
