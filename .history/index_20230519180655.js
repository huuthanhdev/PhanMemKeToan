...
app.post('/chungtu/hoadonGTGT', function(req, res)  {
    ...
    con.query('CALL Them_HDDV(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [SoCT, NgayCT, MaKH, TKNoTT, TKCoDT, TKCoThue, ThueSuat, TienThue,
    HTTT, STK, NganHang, TKChietKhau, TyLeCK, TienCK,
    MaDV, SoLuong, DonGia, TienThanhToan, TienDoanhThu], (error, results) => {
        if (error) {
